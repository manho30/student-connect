<!-- components/study/StudyGroupList.vue -->
<template>
  <div id="study-list-container">
      ...
      >
        ...
        >
          ...
          <div class="space-y-1">
            ...
            >
              Create a study session and invite peers to learn together.
            </p>
          </div>
    ...
    >
      ...
      >
        ...
        >
          <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18.477 16.5 18c-1.746 0-3.332-0.477-4.5 1.253"
          />
        </svg>
      </div>
      ...
      >
        No study sessions match your current search or filter.
        Create one and invite classmates to study together.
      </p>
...
/**
 * Forwards a join request from the study card to the parent view.
 *
 * @param {string} groupId - ID of the study session to join.
 * @returns {void}
 */
...
/**
 * Forwards a leave request from the study card to the parent view.
 *
 * @param {string} groupId - ID of the study session to leave.
 * @returns {void}
 */
...
/**
 * Forwards a study selection event to the parent view.
 *
 * @param {string} groupId - ID of the selected study session.
 * @returns {void}
 */
...
/**
 * Requests that the parent view open the study creation page.
 *
 * @returns {void}
 */
